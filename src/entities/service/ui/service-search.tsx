...
export default function ServiceSearch({ initSearch }: Props) {
  const searchParams = useSearchParams()
  const setSearchStore = useServiceStore((state) => state.setSearch)
    ...
    <Field className="w-full">
      <InputGroup>
        ...
        <InputGroupInput
          ...
          placeholder="Search by name, price, duration and description..."
        />
      </InputGroup>
    </Field>
  )
