...
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from '@/shared/ui/shad-cn/card'
import {
  Field,
  FieldDescription,
  FieldError,
...
import { register } from '@/features/auth/register/model/register'
...
export function SignupForm({ className, ...props }: ComponentProps<'div'>) {
  ...
  const onSubmit = async (data: z.infer<typeof registerSchema>) => {
    await register(data).then(() => router.replace('/dashboard'))
  }
          ...
          <form onSubmit={form.handleSubmit(onSubmit)}>
            <FieldGroup>
              ...
              <Field>
                ...
                <Button variant="outline" type="button" onClick={googleRegister}>
